...
const examples = readFileSync(resolve(__dirname, 'examples.txt')).toString().trim().split('\n')

const input = readFileSync(resolve(__dirname, 'input.txt')).toString().trim().split('\n')
